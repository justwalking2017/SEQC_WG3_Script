...
#$ -pe hostcore 4
#$ -R y
#$ -o /dev/ngs005/scratch/hhong/rep_repro_analysis/CQ/17_snvGT-CS_1119/7_bedtools_alignOut/align.combination.nist.log
...
perl $outdir/alignVcfFetch_vcfV.update1203.nist.v3.pl $sourcedir/"$1"_"$2"_alignerMrg_labMrg_repMrg.txt $1 $2
perl /dev/ngs001/bpan/bin/GIAB_bin/vcfsorter.pl /dev/ngs004/hhong/CQ/hg38/hg38.dict $outdir/"$1"_"$2"_8alignCS_3repCS.vcf >$outdir/"$1"_"$2"_8alignCS_3repCS.sort.vcf
