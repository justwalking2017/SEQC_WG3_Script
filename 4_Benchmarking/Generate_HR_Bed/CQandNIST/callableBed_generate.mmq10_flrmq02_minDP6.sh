...
#$ -pe hostcore 4
#$ -R y
#$ -o /dev/ngs002/hhong/SEQC2/high_reproBed/CQ/z_1_0701new_originalBed/callableBed_mmq10flmr02minDP6.log
...
sourcedir=/dev/ngs004/hhong/CQ/ChineseQuartet_to_hg38/3_Alignment_bamFile
...
outdir=/dev/ngs002/hhong/SEQC2/high_reproBed/CQ/z_1_0701new_originalBed
#cd $outdir
# bam stat
...
#     -T CallableLoci \
#     -R $ref \
#     -I $sourcedir/$1/$2/$2.aln.sorted.dup.RG.bam \
...
java -jar $GATK \
     -T CallableLoci \
     -R $ref \
     -I $sourcedir/$1/$2/$2.aln.sorted.dedup.realigned.recal.bam \
