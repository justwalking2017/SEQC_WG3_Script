...
#$ -pe multicore 1
#$ -R y
#$ -o /dev/ngs002/hhong/SEQC2/high_reproBed/HP/rp_merge_run.log
...
outdir=/dev/ngs002/hhong/SEQC2/high_reproBed/HP/3_replicatesMrg
...
bedtools multiinter -i $sourcedir/"$1"_"$2"_1.GATK.callable_status.bed $sourcedir/"$1"_"$2"_2.GATK.callable_status.bed $sourcedir/"$1"_"$2"_3.GATK.callable_status.bed >$outdir/repMrg_"$1"_"$2".GATK.txt
