...
my $varFile1=$sourdir.'/'.$aligner.'_'.$caller.'/'.'ARD_'.$sample.'_3repCS.sort.vcf';
my $varFile2=$sourdir.'/'.$aligner.'_'.$caller.'/'.'NVG_'.$sample.'_3repCS.sort.vcf';
my $varFile3=$sourdir.'/'.$aligner.'_'.$caller.'/'.'WUX_'.$sample.'_3repCS.sort.vcf';
...
my $export1=$outdir.'/'.$sample.'_'.$aligner.'_'.$caller.'_3labCS_3repCS.vcf';
my $export2=$outdir.'/'.$sample.'_'.$aligner.'_'.$caller.'_3labCS_3rep.noCS.vcf';
my $export3=$outdir.'/'.$sample.'_'.$aligner.'_'.$caller.'_3labCS_3rep.stat.txt';
