...
my $varFile1=$sourdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_1.'.$caller.'.GATK.bedFilt.vcf';
my $varFile2=$sourdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_2.'.$caller.'.GATK.bedFilt.vcf';
my $varFile3=$sourdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_3.'.$caller.'.GATK.bedFilt.vcf';
...
my $export1=$outdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_3repCS.vcf';
my $export2=$outdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_3rep.noCS.vcf';
my $export3=$outdir.'/'.$aligner.'_GATK_'.$caller.'/'.$lab.'_'.$sample.'_3rep.stat.txt';
