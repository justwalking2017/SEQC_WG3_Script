...
#$ -pe hostcore 1 
#$ -R y
#$ -o /dev/ngs005/scratch/hhong/rep_repro_analysis/CQ/17_snvGT-CS_1119/6_bedtools_alignerMrg/vcf_FetchFrmBedtools.log
...
sourcedir=/dev/ngs005/scratch/hhong/rep_repro_analysis/CQ/17_snvGT-CS_1119/5_bedtools_labOut
...
bedtools multiinter -i $sourcedir/"$1"_Bowtie2_GATK_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_Bowtie2_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_BWA_GATK_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_BWA_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_ISAAC_GATK_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_ISAAC_"$2"_3labCS_3repCS.sort.vcf  $sourcedir/"$1"_stampy_GATK_"$2"_3labCS_3repCS.sort.vcf $sourcedir/"$1"_stampy_"$2"_3labCS_3repCS.sort.vcf   >$outdir/"$1"_"$2"_alignerMrg_labMrg_repMrg.txt
