...
#LCL5_Bowtie2_FreeBayes_3labCS_3repCS.sort.vcf

my $varFile1=$sourdir.'/'.$sample.'_HC_8alignCS_3labCS_3repCS.sort.vcf';
my $varFile2=$sourdir.'/'.$sample.'_sentieon_sentieon_3labCS_3repCS.sort.vcf';
my $varFile3=$sourdir.'/'.$sample.'_FreeBayes_8alignCS_3labCS_3repCS.sort.vcf';
my $varFile4=$sourdir.'/'.$sample.'_Samtools_8alignCS_3labCS_3repCS.sort.vcf';
my $varFile5=$sourdir.'/'.$sample.'_SNVer_8alignCS_3labCS_3repCS.sort.vcf';
my $varFile6=$sourdir.'/'.$sample.'_Varscan_8alignCS_3labCS_3repCS.sort.vcf';
my $varFile7=$sourdir.'/'.$sample.'_RTG_RTG_3labCS_3repCS.sort.vcf';
my $varFile8=$sourdir.'/'.$sample.'_ISAAC_8alignCS_3labCS_3repCS.sort.vcf';

my $outdir='/dev/ngs005/scratch/hhong/rep_repro_analysis/CQ/17_snvGT-CS_1119/8_bedtools_allInOneMrg';
my $export1=$outdir.'/'.$sample.'_8callerCS_8alignCS_3labCS_3repCS.vcf';
