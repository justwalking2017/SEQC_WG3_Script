...
#perl $outdir/replicateVcfFetch_vcfV.GATK.update1120.pl $sourcedir/"$1"_GATK_"$2"/ARD_"$3"_repMrg.txt $3 ARD $1 $2 
#perl $outdir/replicateVcfFetch_vcfV.GATK.update1120.pl $sourcedir/"$1"_GATK_"$2"/NVG_"$3"_repMrg.txt $3 NVG $1 $2 
#perl $outdir/replicateVcfFetch_vcfV.GATK.update1120.pl $sourcedir/"$1"_GATK_"$2"/WUX_"$3"_repMrg.txt $3 WUX $1 $2

#perl /dev/ngs001/bpan/bin/GIAB_bin/vcfsorter.pl /dev/ngs004/hhong/CQ/hg38/hg38.dict $outdir/"$1"_GATK_"$2"/ARD_"$3"_3repCS.vcf >$outdir/"$1"_GATK_"$2"/ARD_"$3"_3repCS.sort.vcf
#perl /dev/ngs001/bpan/bin/GIAB_bin/vcfsorter.pl /dev/ngs004/hhong/CQ/hg38/hg38.dict $outdir/"$1"_GATK_"$2"/NVG_"$3"_3repCS.vcf >$outdir/"$1"_GATK_"$2"/NVG_"$3"_3repCS.sort.vcf
#perl /dev/ngs001/bpan/bin/GIAB_bin/vcfsorter.pl /dev/ngs004/hhong/CQ/hg38/hg38.dict $outdir/"$1"_GATK_"$2"/WUX_"$3"_3repCS.vcf >$outdir/"$1"_GATK_"$2"/WUX_"$3"_3repCS.sort.vcf

#bedtools multiinter -i $outdir/"$1"_GATK_"$2"/ARD_"$3"_3repCS.sort.vcf $outdir/"$1"_GATK_"$2"/NVG_"$3"_3repCS.sort.vcf $outdir/"$1"_GATK_"$2"/WUX_"$3"_3repCS.sort.vcf >$labMrgOut/"$3"_"$1"_GATK_"$2"_labMrg_repMrg.txt

perl $outdir/labVcfFetch_vcfV.GATK.update1120.pl $labMrgOut/$3'_'$1'_GATK_'$2'_labMrg_repMrg.txt' $3 $1 $2

perl /dev/ngs001/bpan/bin/GIAB_bin/vcfsorter.pl /dev/ngs004/hhong/CQ/hg38/hg38.dict $labMrgFetch/"$3"_"$1"_GATK_"$2"_3labCS_3repCS.vcf >$labMrgFetch/"$3"_"$1"_GATK_"$2"_3labCS_3repCS.sort.vcf
