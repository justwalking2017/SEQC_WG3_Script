...
#$ -pe multicore 4 
#$ -R y
#$ -o /dev/ngs007/hhong/BedFilt_CQHP/CQ/bedFilter_run.log 
...
java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_GATK_"$2"/"$3"_"$4"_1."$2".GATK.raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_GATK_"$2"/"$3"_"$4"_1."$2".GATK.bedFilt 

java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_GATK_"$2"/"$3"_"$4"_2."$2".GATK.raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_GATK_"$2"/"$3"_"$4"_2."$2".GATK.bedFilt

java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_GATK_"$2"/"$3"_"$4"_3."$2".GATK.raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_GATK_"$2"/"$3"_"$4"_3."$2".GATK.bedFilt

mkdir $outdir/"$1"_"$2"/temp
tempdir=$outdir/"$1"_"$2"/temp
java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_"$2"/"$3"_"$4"_1."$2".raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_"$2"/"$3"_"$4"_1."$2".bedFilt

java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_"$2"/"$3"_"$4"_2."$2".raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_"$2"/"$3"_"$4"_2."$2".bedFilt

java -Djava.io.tmpdir=$tempdir -Xmx20g -jar /dev/ngs002/hhong/bin/rtg-tools-3.9/RTG.jar vcffilter -i $sourcedir/"$1"_"$2"/"$3"_"$4"_3."$2".raw.vcf.gz --bed-regions=$beddir/6_MVRmv_"$4".bed -o $outdir/"$1"_"$2"/"$3"_"$4"_3."$2".bedFilt
