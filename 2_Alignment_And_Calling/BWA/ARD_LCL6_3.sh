#!/bin/sh
#
#$ -N ARD_LCL6_3_BWA_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_3.log
...
outdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_3
mkdir /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_3/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_3/tempdir
