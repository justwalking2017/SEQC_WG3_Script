#!/bin/sh
#
#$ -N NVG_LCL8_2_BWA_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_2.log
...
outdir=/dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_2
mkdir /dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_2/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_2/tempdir
