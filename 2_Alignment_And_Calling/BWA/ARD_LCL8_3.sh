#!/bin/sh
#
#$ -N ARD_LCL8_3_BWA_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL8_3.log
...
outdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL8_3
mkdir /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL8_3/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL8_3/tempdir
