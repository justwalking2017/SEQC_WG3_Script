...
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/ChineseQuartet_to_hg38/3_Alignment_bamFile/BWA/WUX_LCL5_1.reChr21-Y.log
...
#Varscan calling
 ...
 samtools mpileup -B -f $ref -l $outdir/wux_lcl5_1.bed $outdir/WUX_LCL5_1.aln.sorted.dup.RG.bam | java -Djava.io.tmpdir=$tempdir -Xmx40g -jar $VarScan mpileup2cns --p-value 0.05 --variants 1 --output-vcf 1 > $outdir/WUX_LCL5_1.Varscan.chr21-Y.raw.vcf
