#!/bin/sh
#
#$ -N ARD_LCL6_1_BWA_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_1.log
...
outdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_1
mkdir /dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/BWA/ARD_LCL6_1/tempdir
