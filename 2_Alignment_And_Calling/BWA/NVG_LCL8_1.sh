#!/bin/sh
#
#$ -N NVG_LCL8_1_BWA_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_1.log
...
outdir=/dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_1
mkdir /dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/BWA/NVG_LCL8_1/tempdir
