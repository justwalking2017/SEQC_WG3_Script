#!/bin/sh
#
#$ -N WUX_LCL8_3_bowtie2_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL8_3.log
...
outdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL8_3
tempdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL8_3/tempdir
...
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL8_3.FreeBayes.raw.vcf $outdir/WUX_LCL8_3.aln.sorted.dup.RG.bam
echo FreeBayes caller finish at time && echo "`date`"
#########################
echo FreeBayes caller start at time && echo "`date`"
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL8_3.FreeBayes.GATK.raw.vcf $outdir/WUX_LCL8_3.aln.sorted.dedup.realigned.recal.bam
