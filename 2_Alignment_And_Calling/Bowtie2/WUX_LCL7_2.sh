#!/bin/sh
#
#$ -N WUX_LCL7_2_bowtie2_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL7_2.log
...
outdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL7_2
tempdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL7_2/tempdir
