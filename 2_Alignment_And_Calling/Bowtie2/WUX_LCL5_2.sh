#!/bin/sh
#
#$ -N WUX_LCL5_2_bowtie2_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL5_2.log
...
outdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL5_2
tempdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/WUX_LCL5_2/tempdir
...
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_2.FreeBayes.raw.vcf $outdir/WUX_LCL5_2.aln.sorted.dup.RG.bam
echo FreeBayes caller finish at time && echo "`date`"
#########################
echo FreeBayes caller start at time && echo "`date`"
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_2.FreeBayes.GATK.raw.vcf $outdir/WUX_LCL5_2.aln.sorted.dedup.realigned.recal.bam
