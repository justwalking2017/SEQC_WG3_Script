...
echo 'F01=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/Quartet_DNA_ILM_'$name'_20170216_R1.fastq.gz' >> $name.sh  # please check data diectory
echo 'F02=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/Quartet_DNA_ILM_'$name'_20170216_R2.fastq.gz' >> $name.sh # please check data diectory
