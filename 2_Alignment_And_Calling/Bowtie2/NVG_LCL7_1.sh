#!/bin/sh
#
#$ -N NVG_LCL7_1_bowtie2_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/Bowtie2/NVG_LCL7_1.log
...
mkdir /dev/ngs004/hhong/CQ/wf/Bowtie2/NVG_LCL7_1
outdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/NVG_LCL7_1
mkdir /dev/ngs004/hhong/CQ/wf/Bowtie2/NVG_LCL7_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/Bowtie2/NVG_LCL7_1/tempdir
