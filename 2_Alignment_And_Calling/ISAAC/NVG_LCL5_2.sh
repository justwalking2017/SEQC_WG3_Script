#!/bin/sh
#
#$ -N NVG_LCL5_2_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL5_2.log

# datasets
sample=NVG_LCL5_2
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170329_DNA_ILM_NVG/NVG_LCL5_2
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL5_2
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL5_2
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL5_2/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL5_2/tempdir
# ISAAC align
