#!/bin/sh
#
#$ -N WUX_LCL5_1_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 16
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_1.log

# datasets
sample=WUX_LCL5_1
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/WUX_LCL5_1
## set path
...
# mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_1
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_1
# mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_1/tempdir
# ISAAC align
...
# $FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_1.FreeBayes.raw.vcf $outdir/WUX_LCL5_1.aln.sorted.dup.RG.bam
# echo FreeBayes caller finish at time && echo "`date`"
#########################
echo FreeBayes caller start at time && echo "`date`"
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_1.FreeBayes.GATK.raw.vcf $outdir/WUX_LCL5_1.aln.sorted.dedup.realigned.recal.bam
echo FreeBayes caller finish at time && echo "`date`"
