#!/bin/sh
#
#$ -N ARD_LCL7_1_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL7_1.log

# datasets
sample=ARD_LCL7_1
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170403_DNA_ILM_ARD/ARD_LCL7_1
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL7_1
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL7_1
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL7_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL7_1/tempdir
# ISAAC align
