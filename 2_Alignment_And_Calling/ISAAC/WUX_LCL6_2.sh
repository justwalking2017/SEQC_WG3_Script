#!/bin/sh
#
#$ -N WUX_LCL6_2_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_2.log

# datasets
sample=WUX_LCL6_2
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/WUX_LCL6_2
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_2
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_2
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_2/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_2/tempdir
# ISAAC align
...
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL6_2.FreeBayes.raw.vcf $outdir/WUX_LCL6_2.aln.sorted.dup.RG.bam
echo FreeBayes caller finish at time && echo "`date`"
#########################
echo FreeBayes caller start at time && echo "`date`"
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL6_2.FreeBayes.GATK.raw.vcf $outdir/WUX_LCL6_2.aln.sorted.dedup.realigned.recal.bam
echo FreeBayes caller finish at time && echo "`date`"
