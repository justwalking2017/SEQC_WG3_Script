#!/bin/sh
#
#$ -N ARD_LCL6_3_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL6_3.log

# datasets
sample=ARD_LCL6_3
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170403_DNA_ILM_ARD/ARD_LCL6_3
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL6_3
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL6_3
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL6_3/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_LCL6_3/tempdir
# ISAAC align
