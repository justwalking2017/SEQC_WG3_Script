#!/bin/sh
#
#$ -N WUX_LCL5_3_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 24
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_3.log

# datasets
sample=WUX_LCL5_3
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/WUX_LCL5_3
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_3
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_3
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_3/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL5_3/tempdir
# ISAAC align
echo ISAAC alignment start at time && echo "`date`"
isaac-align -r $isaacindex/sorted-reference.xml -b $F --base-calls-format fastq-gz -j 24 --verbosity 3  --stop-at Bam --input-parallel-load 24 --temp-parallel-load 8 --keep-unaligned back --realign-gaps yes -o $outdir -m 80 -t $tempdir/Temp  --stats-image-format none --variable-read-length yes;
...
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_3.FreeBayes.raw.vcf $outdir/WUX_LCL5_3.aln.sorted.dup.RG.bam
echo FreeBayes caller finish at time && echo "`date`"
#########################
echo FreeBayes caller start at time && echo "`date`"
$FreeBayes -f $ref -X -u -v $outdir/WUX_LCL5_3.FreeBayes.GATK.raw.vcf $outdir/WUX_LCL5_3.aln.sorted.dedup.realigned.recal.bam
echo FreeBayes caller finish at time && echo "`date`"
