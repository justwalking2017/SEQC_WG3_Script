#!/bin/sh
#
#$ -N NVG_LCL8_1_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL8_1.log

# datasets
sample=NVG_LCL8_1
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170329_DNA_ILM_NVG/NVG_LCL8_1
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL8_1
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL8_1
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL8_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/NVG_LCL8_1/tempdir
# ISAAC align
