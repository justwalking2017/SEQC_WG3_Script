#!/bin/sh
#
#$ -N ARD_NIST8398_3_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 8
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_NIST8398_3.log

# datasets
sample=ARD_NIST8398_3
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170403_DNA_ILM_ARD/ARD_NIST8398_3
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_NIST8398_3
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_NIST8398_3
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/ARD_NIST8398_3/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/ARD_NIST8398_3/tempdir
# ISAAC align
