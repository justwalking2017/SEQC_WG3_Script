#!/bin/sh
#
#$ -N WUX_LCL6_1_ISAAC_aligner
#$ -S /bin/bash
#$ -cwd
#$ -j y
#$ -pe multicore 16
#$ -R y
#$ -o /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_1.log

# datasets
sample=WUX_LCL6_1
F=/dev/ngs004/hhong/CQ/data/Quartet/DNA/20170216_DNA_ILM_WUX/WUX_LCL6_1
## set path
...
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_1
outdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_1
mkdir /dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_1/tempdir
tempdir=/dev/ngs004/hhong/CQ/wf/ISAAC/WUX_LCL6_1/tempdir
# ISAAC align
echo ISAAC alignment start at time && echo "`date`"
isaac-align -r $isaacindex/sorted-reference.xml -b $F --base-calls-format fastq-gz -j 16 --verbosity 3  --stop-at Bam --input-parallel-load 16 --temp-parallel-load 16 --keep-unaligned back --realign-gaps yes -o $outdir -m 64 -t $tempdir/Temp  --stats-image-format none --variable-read-length yes;
